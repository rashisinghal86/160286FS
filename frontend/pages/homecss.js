export default {
    ...
    <em class="text-muted">
       ...
       this is a simple application that allows professional and customers to register and request for
        ...
        <div class="col-md-4 mb-3">
            <div class="card" style="width: 100%;">
                <div class="card-body d-flex flex-column align-items-center">
                    ...
                    <a href="{{ url_for('login') }}" class="btn btn-light stretched-link">
        ...
        <div class="col-md-4 mb-4">
            <div class="card" style="width: 100%;">
                <div class="card-body d-flex flex-column align-items-center">
                    ...
                    <a href="{{ url_for('register') }}" class="btn btn-light stretched-link">
        ...
        <div class="col-md-4 mb-3">
            <div class="card" style="width: 100%;">
                <div class="card-body d-flex flex-column align-items-center">
                    ...
                    <a href="https://www.youtube.com/watch?v=YOUR_VIDEO_ID" class="btn btn-light stretched-link"
                        target="_blank">
